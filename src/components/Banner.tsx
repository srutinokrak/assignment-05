      ...
      <section className="container mx-auto px-6 py-16">
                  <div className="md:flex items-center justify-between gap-10">
                    <div className="max-w-xl">
                      ...
                      <div className="mt-7 flex gap-3">
                        <button className="rounded-md bg-linear-to-r from-orange-500 to-purple-600  px-5 py-2 text-sm text-white">
                          Explore Technologies
                        </button>
                        <button className="rounded-md border border-gray-300 px-5 py-2 text-sm text-gray-600">
                          Learn More
                        </button>
                      </div>
                    </div>
                  ...
                  <div className="mx-auto mb-20">
                    <h2 className="font-bold text-3xl">
                      Explore the{" "}
                      <span className="bg-linear-to-r from-pink-700 to-purple-600 bg-clip-text text-transparent">
                        Technologies
                      </span>
                    </h2>
